(function(){
  ...
  window.i18nData = {
    ...
    "home": {
      "hero_title": "أهلاً بكم في متجر العطر الأصلي",
      "hero_text": "نوفر لكم أجود أنواع العطور الأصلية والعكر الأصلي بأسعار مميزة وتوصيل سريع لجميع المناطق",
      "categories_title": "الفئات الرئيسية",
      "about_title": "نبذة عن المتجر",
      "about_text": "في متجر العطر الأصلي نمنحك أكثر من مجرد عطر... نمنحك تجربة راقية تجمع بين الأصالة والجودة العالمية وخدمة عملاء تهتم بأدق التفاصيل، كما نوفر العكر الأصلي لعشاق الروائح التقليدية.",
    ...
    "pages": {
      "home": {
        ...
        "description": "متجر العطر الأصلي يقدم أجود أنواع العطور الأصلية والعكر الأصلي بأسعار مميزة وتوصيل سريع لجميع المناطق",
        "keywords": "متجر العطر الأصلي, العكر الأصلي, al3ter-alasli"
      },
      "cart": {
        "title": "السلة",
      ...
      "about": {
        "title": "من نحن",
        "content": "في العطر الأصلي نمنحك أكثر من مجرد عطر... نمنحك تجربة راقية تجمع بين الأصالة والجودة العالمية وخدمة عملاء تهتم بأدق التفاصيل.",
