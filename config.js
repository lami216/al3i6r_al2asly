(function(){
  ...
  window.i18nData = {
    ...
    "home": {
      "hero_title": "أهلاً بكم في متجر الصاحب",
      "hero_text": "نوفر لكم في متجر الصاحب - alsahib-dd تشكيلة فاخرة من العطور الأصلية والعناية العطرية مع توصيل سريع وخدمة عملاء ترافقكم في كل طلب.",
      "categories_title": "الفئات الرئيسية",
      "about_title": "نبذة عن المتجر",
      "about_text": "في متجر الصاحب نمنحك أكثر من مجرد عطر... نمنحك تجربة فاخرة تجمع بين الأصالة والابتكار وخدمة عملاء تهتم بأدق التفاصيل، مع توفير تشكيلة alsahib-dd لعشاق الروائح الراقية.",
    ...
    "pages": {
      "home": {
        ...
        "description": "متجر الصاحب - alsahib-dd يقدم أجود أنواع العطور الأصلية والعناية العطرية الراقية مع عروض خاصة وتوصيل سريع إلى جميع المناطق",
        "keywords": "متجر الصاحب, alsahib-dd, عطور الصاحب"
      },
      "cart": {
        "title": "السلة",
      ...
      "discounts": {
        ...
        "description": "عطور مع عروض حصرية وتخفيضات خاصة"
      },
      "best": {
        "title": "الأكثر مبيعاً",
      ...
      "about": {
        "title": "من نحن",
        "content": "في متجر الصاحب نقدم لكم رحلة فاخرة في عالم العطور تجمع بين الخبرة الطويلة واللمسات العصرية، لنضمن لكم تجربة تسوق متميزة وخدمة راقية في كل مرة.",
        "description": "تعرف على متجر الصاحب"
      },
      "contact": {
        "title": "تواصل معنا",
      ...
      "privacy": {
        ...
        "description": "سياسة الخصوصية لمتجر الصاحب"
      },
      "terms": {
        "title": "الشروط والأحكام",
        "content": "باستخدامك للموقع فإنك توافق على الشروط والأحكام التالية",
        "description": "شروط استخدام متجر الصاحب"
      },
      "not_found": {
  ...
  function applyStructuredData(){
    const data = {
      ...
      "logo": window.location.origin + '/image/alsahib-dd-logo.svg'
    };
